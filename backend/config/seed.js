...
const fiatBaseModels = [
  ...
  { modelo: 'Strada', anos: [2008, 2026], motorizacoes: ['1.3 Firefly', '1.4 Fire', '1.6 E.torQ', '1.8 Powertrain', '1.0 Turbo 200'], cambios: ['Manual', 'Automático CVT', 'Automatizado (Dualogic)'] },
  ...
  { modelo: 'Toro', anos: [2016, 2026], motorizacoes: ['1.8 E.torQ', '2.4 Tigershark', '1.3 Turbo 270', '2.0 Turbodiesel', '2.2 Turbodiesel'], cambios: ['Manual', 'Automático 6 Marchas', 'Automático 9 Marchas'] },
  ...
  { modelo: 'Pulse', anos: [2021, 2026], motorizacoes: ['1.3 Firefly', '1.0 Turbo 200', '1.3 Turbo 270 (Abarth)'], cambios: ['Manual', 'Automático CVT', 'Automático 6 Marchas'] },
  { modelo: 'Fastback', anos: [2022, 2026], motorizacoes: ['1.0 Turbo 200', '1.3 Turbo 270'], cambios: ['Automático CVT', 'Automático 6 Marchas'] },
...
async function seedDatabase() {
  try {
    ...
    if (count === 0) {
      console.log('🌱 Gerando combinações de veículos FIAT de 2008 até 2026...');
      ...
      console.log(`🚀 Inserindo ${generatedVehicles.length} versões de veículos FIAT no banco de dados...`);
      await Vehicle.bulkCreate(generatedVehicles);
      console.log('✅ Base completa de veículos FIAT inserida com sucesso!');
    } else {
      console.log('ℹ️ O banco de dados já possui veículos cadastrados. Pulando inserção inicial.');
    }
  } catch (error) {
